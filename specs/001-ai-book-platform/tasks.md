...
- [X] T020 [P] [US3] Create a reusable chat widget component in `frontend/src/components/ChatWidget/index.js`.
- [X] T021 [P] [US3] Add the `ChatWidget` to the Docusaurus layout and connect it to the `/chat` API endpoint.
